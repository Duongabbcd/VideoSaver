...
import com.example.videosaver.databinding.ItemProgressBinding
...
class ProgressAdapter(
    ...
    class ProgressViewHolder(val binding: ItemProgressBinding) :
        ...
        fun bind(progressInfo: ProgressInfo, progressListener: ProgressListener) {
            ...
            val color =
                MaterialColors.getColor(itemView.context, com.google.android.material.R.attr.colorSurfaceVariant, Color.YELLOW)
