package com.example.videosaver.utils.advance.proxy_utils
...
class OkHttpProxyClient @Inject constructor(
    ...
    private var currentProxy: com.example.videosaver.advance.data.local.model.Proxy
    ...
    fun getProxyOkHttpClient(): OkHttpClient {
        ...
        if (proxy.host != currentProxy.host && proxy.port != currentProxy.port || (httpClientCached == null)) {
            ...
            httpClientCached =
                if (proxy == com.example.videosaver.advance.data.local.model.Proxy.noProxy()) {
    ...
    private fun getProxy(): com.example.videosaver.advance.data.local.model.Proxy {
