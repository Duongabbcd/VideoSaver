package com.example.videosaver.screen.home.subscreen.advance
...
import com.example.videosaver.screen.home.subscreen.HomeFragment.Companion.changeTab
...
class BrowseFragment(private var urlNew: String = "https://www.google.com") : BaseFragment<FragmentBrowseBinding>(
    FragmentBrowseBinding::inflate
) {
    var webIcon: Bitmap? = null

    private lateinit var mainRef : MainActivity
